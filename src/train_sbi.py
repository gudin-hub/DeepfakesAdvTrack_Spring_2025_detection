...
def main(args):
    ...
    if cfg.get('pretrained_path'):
        print('Loading pretrained model from:', cfg['pretrained_path'])
...
if __name__=='__main__':
    ...
    parser.add_argument('--pretrained_path',dest='pretrained_path',default='SelfBlendedImages-master/weights/FFraw.tar')
